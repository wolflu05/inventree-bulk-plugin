 ...
 */
export function RenderPurchaseOrder(props: Readonly<InstanceRenderInterface>) {
  ...
  return (
    <RenderInlineModel
      ...
      url={props.link ? getDetailUrl(ModelType.purchaseorder, instance.pk) : undefined}
    />
  );
}
 ...
 */
export function RenderReturnOrder(props: Readonly<InstanceRenderInterface>) {
  const { instance } = props;
  ...
  return (
    <RenderInlineModel
      ...
      url={props.link ? getDetailUrl(ModelType.returnorder, instance.pk) : undefined}
    />
  );
}

export function RenderReturnOrderLineItem(props: Readonly<InstanceRenderInterface>) {
  const { instance } = props;
 ...
 */
export function RenderSalesOrder(props: Readonly<InstanceRenderInterface>) {
  const { instance } = props;
  const customer = instance?.customer_detail || {};
  ...
  return (
    <RenderInlineModel
      ...
      image={customer.thumnbnail || customer.image}
      url={props.link ? getDetailUrl(ModelType.salesorder, instance.pk) : undefined}
    />
  );
}
...
export function RenderSalesOrderShipment({
  ...
  return <RenderInlineModel primary={order.reference} secondary={`Shipment ${instance.reference}`} />;
}
